                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                                                    <div class="single-product">
                                                        <div class="product-img">
                                                            <a href="productdetail?pid=${o.id}&tag=products">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="owl-carousel popular-slider">
                                                    ...
                                                    <c:forEach items="${listHotItem}" var="p">
                                                        <div class="single-product">
                                                            <div class="product-img">
...
<!--                                            <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <!--                                                Start Single List  -->
                                                <c:forEach items="${listBestSellerItem}" var="p">
                                                    <div class="single-list">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="list-image overlay">
                                                                    <img src="${p.image}" alt="productdetail?pid=${p.id}&tag=products">
                                                                    <a href="productdetail?pid=${p.id}&tag=products" class="buy"><i class="fa fa-shopping-bag"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-12 no-padding">
                                                                <div class="content">
                                                                    <h5 class="title"><a href="#">${p.title}</a></h5>
                                                                    <p class="price with-discount">$${p.price}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                ...
                                                <!--                                                Start Single List  -->
                                                <c:forEach items="${listTopViewItem}" var="p">
                                                    <div class="single-list">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-12">
                                                                <div class="list-image overlay">
